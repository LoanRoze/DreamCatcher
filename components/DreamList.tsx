                ...
                {filteredDreams.map((dream, index) => (
                    <View style={styles.card}>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => <Text style={styles.tag}>#{item.label}</Text>}
                        />
                        ...
                        <FlatList
                            ...
                            horizontal
                            keyExtractor={(item, index) => index.toString()}
                            renderItem={({ item }) => <Text style={styles.peopleTag}>👤{item}</Text>}
                        />

                        <Text style={styles.footer}>🕒 {dream.hour} | 📅 {dream.date}</Text>
                        <Button
                            mode="contained"
